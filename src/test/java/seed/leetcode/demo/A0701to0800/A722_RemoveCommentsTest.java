...
public class A722_RemoveCommentsTest {

	@Test
	public void test() {
		A722_RemoveComments a = new A722_RemoveComments();
		...
		res = a.removeComments(new String[] { "a/*comment", "line", "more_comment*/b" });
		System.out.println(Arrays.toString(res.toArray()));

		res = a.removeComments(new String[] { "void func(int k) {", "// this function does nothing /*", "   k = k*2/4;",
				"   k = k/2;*/", "}" });
		System.out.println(Arrays.toString(res.toArray()));

		res = a.removeComments(new String[] { "main() {", "/* here is commments", "  // still comments */",
				"   double s = 33;", "   cout << s;", "}" });
		System.out.println(Arrays.toString(res.toArray()));
		...
		res = a.removeComments(
				new String[] { "/*/dadb/*/aec*////*//*ee*//*//b*////*badbda//*bbacdbbd*//ceb//*cdd//**//de*////*",
		...
		// eb/*///*cd*//dcdbaaadd//*ced/*/dcabe//*//*a/*//*///*ea*///*//*/*//b/*//*/dd/*/","ba*//e*//cd//*/*/dd/*/*//dd//**//aab//**//*//*//d/*//*/*//*//*//cddecbbb//*ee*//
	}
}
